    ...
    <ProtectedRoute>
      <div className="min-h-screen bg-gradient-to-br from-secondary/20 via-background to-primary/5">
        ...
        <main className="container max-w-2xl mx-auto px-3 sm:px-4 py-4 sm:py-6 pb-20 sm:pb-6">
          ...
          <div className="mb-4 sm:mb-6">
            <h1 className="text-2xl sm:text-3xl font-bold text-balance">Deposit Money</h1>
            <p className="text-muted-foreground mt-2 text-sm sm:text-base">Add funds to your cashout account</p>
          </div>
          <DepositForm />
        </main>
      </div>
